...
gymclass1 = GymClass.new({'name' => 'Kettlebells', 'day' => 'Wednesday', 'start_time' => '18:00', 'duration' => '45 mins'})
gymclass1.save()

booking1 = Booking.new({'member_id' => member1.id, 'class_id' => gymclass1.id})
booking1.save()

gymclass2 = GymClass.new({'name' => 'Zumba', 'day' => 'Monday', 'start_time' => '19:00', 'duration' => '60 mins'})
gymclass2.save()

booking2 = Booking.new({'member_id' => member1.id, 'class_id' => gymclass2.id})
booking2.save()

new_gymclass = GymClass.new(({'name' => 'Zumba', 'day' => 'Saturday', 'start_time' => '12:00', 'duration' => '45 mins'}))
new_gymclass.save()

new_bookings = Booking.new({'member_id' => member1.id, 'class_id' => new_gymclass.id})
new_bookings.save()

gymclass3 = GymClass.new({'name' => 'Pound', 'day' => 'Tuesday', 'start_time' => '11:30', 'duration' => '45 mins'})
gymclass3.save()

gymclass4 = GymClass.new({'name' => 'Yoga', 'day' => 'Saturday', 'start_time' => '09:00', 'duration' => '60 mins'})
gymclass4.save()
